const CACHE_NAME='gringotts-budget-vault-v63';
const APP_SHELL=['/','/index.html','/styles/main.css','/src/state.js','/src/storage.js','/src/importer.js','/src/rules.js','/src/reports.js','/src/ui.js','/src/differential.js','/src/health.js','/src/update-repair.js','/src/pwa.js','/src/app.js','/src/app-v61.js','/manifest.webmanifest','/icons/icon.svg','/icons/maskable-icon.svg'];
