const CACHE_NAME='gringotts-budget-vault-v79';
const APP_SHELL=['/','/index.html','/styles/main.css','/src/state.js','/src/storage.js','/src/importer.js','/src/rules.js','/src/reports.js','/src/ui.js','/src/differential.js','/src/health.js','/src/update-repair.js','/src/v64-data-guard.js','/src/v65-vault-safety.js','/src/v66-cashflow.js','/src/v67-debt.js','/src/v68-promo-briefing.js','/src/v69-executive-dashboard.js','/src/v70-monthly-executive.js','/src/v71-executive-polish.js','/src/v72-dashboard-month-picker.js','/src/v73-executive-drilldown.js','/src/v74-executive-actions.js','/src/v75-release-sync.js','/src/v79-cashflow-ii.js','/src/pwa.js','/src/app.js','/src/app-v61.js','/manifest.webmanifest','/icons/icon.svg','/icons/maskable-icon.svg'];
