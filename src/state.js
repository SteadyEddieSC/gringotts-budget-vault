(function(){
  ...
  const ROADMAP=[
    ['v78','Debt Planner II','Merge promo APR watch into debt payoff strategy and monthly payoff targets.'],
    ['v79','Cash Flow II','Manual bill overrides, payday markers, and safer recurring bill controls.'],
    ['v80','Family Budget Meeting Pack','Quick-read meeting notes, decisions, and household action list.'],
  ...
  function defaultState(){return {version:'v77',createdAt:new Date().toISOString(),lastSavedAt:'',source:null,transactions:[],rules:[],review:{cursor:0},settings:{windowDays:60},meta:{imports:[],notes:[],lastDiff:null,ruleConflicts:null,health:null,lastUpdateRepair:null,lastRecovery:null,activeStorageKey:null}};}
  window.GBV={
    VERSION:'v77',
    STORAGE_KEY:'gringottsBudgetVault.v77',
    PREVIOUS_KEYS:['gringottsBudgetVault.v76','gringottsBudgetVault.v75','gringottsBudgetVault.v74','gringottsBudgetVault.v73','gringottsBudgetVault.v72','gringottsBudgetVault.v71','gringottsBudgetVault.v70','gringottsBudgetVault.v69','gringottsBudgetVault.v68','gringottsBudgetVault.v67','gringottsBudgetVault.v66','gringottsBudgetVault.v65','gringottsBudgetVault.v64','gringottsBudgetVault.v63','gringottsBudgetVault.v62','gringottsBudgetVault.v61','gringottsBudgetVault.v60','gringottsBudgetVault.v59','gringottsBudgetVault.v58','gringottsBudgetVault.v57','gringottsBudgetVault.v56','gringottsBudgetVault.latest'],
