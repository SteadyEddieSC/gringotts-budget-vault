import './boot-v126.js?v=127base2';
...
function updateMetadata() {
  ...
  if (build) Object.assign(build, { version: RELEASE.version, name: RELEASE.name, runtime: `${build.runtime || 'v126 runtime'} + v127 interaction policy and surface polish`, cacheBust: '127ux2' });
